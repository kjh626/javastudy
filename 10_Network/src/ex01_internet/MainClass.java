...
public class MainClass {
	...
	*/
	...
	public static void ex06() {		// 연습
		...
		// 1시간마다 갱신되는 전국 날씨 정보(텍스트로 이루어진 파일)
	...
	public static void ex06_buffered() {
		...
		try {
			...
			if(responseCode == HttpURLConnection.HTTP_OK) {
				...
				file = new File("C:" + File.separator + "pracstorage", "sfc_web_map.xml");
				message = "다운로드 성공";
			} else {
				reader = new BufferedReader(new InputStreamReader(con.getErrorStream()));
				file = new File("C:" + File.separator + "pracstorage", "다운로드실패.html");
				message = "다운로드 실패";
			}
